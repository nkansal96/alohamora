...
@command.argument('--model', help='The RL technique used during training for the saved model',
                  required=True, choices=['APEX', 'PPO'])
...
def serve(args):
  ...
  log.info('starting server...',
           model=args.model, location=args.location, host=args.host,
           port=args.port, max_workers=args.max_workers)
