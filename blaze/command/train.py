...
@command.description('Trains a model to generate push policies for the given website. This command takes as input the\
 manifest file generated by `blaze preprocess` and output a model that can be served in real-time.')
...
@command.argument('--manifest_file', help='A description of the website that should be trained. This should be the file\
